...
import sudark.rentland.RentLand;
...
public class FileManager {
    ...
    public static File landFolder = Bukkit.getPluginManager().getPlugin("RentLand").getDataFolder();
    public static File landFile = new File(landFolder, "land.csv");

    static File configFile = new File(landFolder, "config.yml");
    public static File courierFile = new File(Bukkit.getPluginManager().getPlugin("Courier").getDataFolder(), "allowlist.csv");
